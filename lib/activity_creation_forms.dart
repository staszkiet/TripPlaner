...
class _AttractionCreationFormState extends State<AttractionCreationForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: widget.toEdit == null ? Text("Add attraction") : Text("Edit attraction"),),
      body:Material(
      child: Row(children: [
        Flexible(flex: 1, child: Container()),
        Flexible(flex:3, child: Form(
          key: _formKey,
...
class _SleepoverCreationFormState extends State<SleepoverCreationForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: widget.toEdit == null ? Text("Add sleepover") : Text("Edit sleepover"),),
      body: Material(
        child: Row(children: [
      Flexible(
        flex: 1,
