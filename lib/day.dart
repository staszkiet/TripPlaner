...
class DayPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ListView.builder(itemCount: attractions.items.length,
          itemBuilder: (context, index) => Text(attractions.items[index].name),
          shrinkWrap: true,
          ),
          Text(day.index.toString()),
          IconButton(icon: Icon(Icons.fire_truck), onPressed: (){attractions.addItem(Attraction("dodane w dniu"));},),
        ],
      ),
    );
  }
